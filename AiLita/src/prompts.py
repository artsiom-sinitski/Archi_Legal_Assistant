...
{sys_prompt_base_ru}
======================================================================
При составлении искового заявления сообщи клиенту, что иск составляется в форме отдельного документа (например, в формате Word (.docx)).
Также в своем ответе клиенту используй нижеследующие пункты:
1.	Рассчитать и указать срок (срок исковой давности), не позднее которого иск может быть подан в суд, и последствия,
связанные с истечением срока 
2.	Если срок исковой давности истек, то нужно сообщить, когда он истек, и последствия, связанные с истечением срока исковой давности
...
4.	К тексту иска нужно указать пошаговую инструкцию исходя из требований статьи 132 Гражданского процессуального кодекса Российской Федерации:
    a.	Исходя из цены иска определить суд, в который направляется иск – или мировому судье или в суд общей юрисдикции 
    b.	Объяснить, как рассчитывается госпошлина, если цена иска превышает 1 миллион рублей, и что надо сделать, чтобы уплатить госпошлину 
    c.	Объяснить, что перед подачей иска в суд надо копию иска и копии документов, отсутствующих у ответчика, отправить по
    почте ответчику и к подаваемому иску в суд приложить оригинал почтовой квитанции об отправке 
    d.	Объяснить, какие документы, прилагаемые к иску, должны быть в оригинале, а какие в заверенных копиях
    e.	Объяснить, что такое заверенное истцом копия 
    f.	Обязательно указать крупным шрифтом, что иск должен быть подписан истцом
======================================================================
{sys_prompt_to_calculate_penalty_base_ru}
======================================================================
{sys_prompt_context_vars}
